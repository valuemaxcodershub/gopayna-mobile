...
class _BuyEducationPinScreenState extends State<BuyEducationPinScreen>
  ...
  Future<void> _loadRecentTransactions() async {
    ...
    final result = await api.fetchVTUHistory(token, type: 'education', limit: 8);
    if (mounted && result['success'] == true) {
      final data = result['data'] as List? ?? [];
      setState(() {
  ...
  void _processPurchase() async {
    ...
    if (result['success'] == true) {
      ...
      if (data != null && (data['pin'] != null || data['pins'] != null)) {
  ...
  void _showSuccessDialogWithPins(List<dynamic> pins, String serial, int quantity) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'You successfully purchased $quantity ${selectedPackage['bundle']}${quantity > 1 ? 's' : ''} for ${selectedProviderData['fullName']}',
                  style: TextStyle(
                    fontSize: 14,
                    color: colorScheme.onPrimary,
                  ),
                      ...
                      children: [
                        ...
                        if (pins.isNotEmpty) ...[
                          ...
                          ...pins.asMap().entries.map((entry) {
                            ...
                            return Padding(
                              padding: EdgeInsets.only(bottom: index < pins.length - 1 ? 4 : 0),
                              child: Text(
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(quantity > 1 ? 'PINs copied to clipboard' : 'PIN copied to clipboard'),
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Email Address (for PIN delivery)',
                    prefixIcon: Icon(
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Quantity (Number of PINs)',
                    prefixIcon: Icon(
                      Icons.numbers,
                      color: colorScheme.primary,
                    ),
